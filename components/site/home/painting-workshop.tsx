    ...
    <div className="relative overflow-x-clip bg-[#0E0D0C] text-[#F2EBDD]" style={{ "--paint-accent": accent.hex, "--accent": accent.hex } as CSSProperties}>
      ...
      <section className="relative z-[2] flex min-h-[92svh] items-end overflow-hidden pb-[clamp(40px,6vh,70px)] pt-[clamp(120px,17vh,190px)]">
        ...
        <div className="site-container relative z-[3]">
          ...
          <div data-reveal style={{ "--reveal-delay": "140ms" } as CSSProperties} className="mt-[34px] flex flex-wrap gap-3.5"><a href="https://www.instagram.com/piccolo_teatro_di_bizerta/" target="_blank" rel="noopener noreferrer" className="bg-[var(--paint-accent)] px-7 py-4 text-xs uppercase tracking-[.16em] text-[#F2EBDD] transition hover:-translate-y-[3px] hover:shadow-[0_18px_44px_rgba(0,0,0,.6)]">Écrire sur Instagram</a><Link href="#pratique" className="border border-[rgba(242,235,221,.3)] px-7 py-4 text-xs uppercase tracking-[.16em] transition hover:-translate-y-[3px] hover:border-[#F2EBDD]">Infos pratiques</Link></div>
        </div>
      </section>
